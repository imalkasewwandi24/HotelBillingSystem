...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="addRoom.jsp"><i class="fas fa-door-open"></i> Add Rooms</a>
        <a href="${pageContext.request.contextPath}/admin/ViewRoomServlet"><i class="fas fa-bed"></i>Manage Rooms</a>
        <a href="${pageContext.request.contextPath}/admin/ViewReservationServlet"><i class="fas fa-calendar-check"></i>All Reservations</a>
