...
<head>
  <meta charset="UTF-8">
  <title>Bill Records - Resort</title>
  ...
  <div class="form-container">
    ...
    <table class="table table-hover table-bordered">
      ...
      <tr>
        ...
        <td>
          <%= b.getBillDate() != null ?
                  sdf.format(b.getBillDate()) : "-" %>
        </td>

        <td>
          <%= String.format("%.0f", b.getDiscount()) %>%
        </td>

        <td>
          <%= String.format("%.0f", b.getServiceCharge()) %>%
        </td>
  ...
  document.getElementById('searchInput')
          .addEventListener('keyup', function () {
            ...
            rows.forEach(row => {
              ...
              row.style.display =
                      (resId.includes(filter) || date.includes(filter))
                              ? ''
                              : 'none';
            });
          });
