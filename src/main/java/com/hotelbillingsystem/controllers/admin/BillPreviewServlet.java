...
@WebServlet("/admin/BillPreviewServlet")
public class BillPreviewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (billIdStr == null || billIdStr.isEmpty()) {
            response.sendRedirect(request.getContextPath() + "/admin/ViewBillServlet");
            return;
        }
        ...
        request.getRequestDispatcher("/admin/billPreview.jsp").forward(request, response);
    }
}
